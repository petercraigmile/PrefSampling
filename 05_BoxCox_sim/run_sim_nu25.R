...
for (chain.num in 1:200) {
    ...
    pdf(file=paste0("figures/nu25_trace_plots", chain.num, ".pdf"), width=8, height=6.5)
    ...
    save(list=c("chs", "pp", "sim", "cell.area"),
         file=paste0("output/nu25_sim", chain.num, ".RData"))
    ...
    pdf(file=paste0("figures/nu25_kappa0_trace_plots", chain.num, ".pdf"), width=8, height=6.5)
    ...
    save(list=c("chs", "pp", "sim", "cell.area"),
         file=paste0("output/nu25_kappa0_sim", chain.num, ".RData"))
